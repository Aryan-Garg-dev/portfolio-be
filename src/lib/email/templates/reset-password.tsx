...
export const DropboxResetPasswordEmail = ({ userFirstname, resetPasswordLink }: DropboxResetPasswordEmailProps) => {
	return (
		<Html>
			<Head />
			<Body style={main}>
				...
				<Container style={container}>
					...
					<Section>
						...
						<Text style={text}>
							Someone recently requested a password change for your Dropbox account. If this was you, you can set a new
							password here:
						</Text>
